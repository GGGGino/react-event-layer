...
class WrapperLayers extends React.Component<any, any> {
  layers: any;
    ...
    return (
      ...
      >
        {childrenOrdered.map((item, i) => {
          const childProps = {
            ref: (input: any) => { this.layers[`layer${i}`] = input },
            ...item.props
          };
          ...
          return (
            <div key={item.props.z} style={defaultStyle} style={customStyle}>
              {(currStyle) => {
